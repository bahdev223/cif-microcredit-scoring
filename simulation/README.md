...
Les fichiers de configuration décrivent l'institution, les produits, secteurs et horizon de simulation. Les générateurs créeront ensuite les tables CSV de `data/synthetic/raw/`.
